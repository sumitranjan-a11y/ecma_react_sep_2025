                ...
                <div className="col-sm-6 offset-sm-3">
                    <form className="justify-content-center" onSubmit={onSave}>
                        <fieldset>
                            ...
                            <TextInput name="id" label="Product Id" value={product.id} onChange={onChange} />
                            <TextInput name="name" label="Product Name" value={product.name} onChange={onChange} />
                            <TextInput name="description" label="Product Description" value={product.description} onChange={onChange} />
